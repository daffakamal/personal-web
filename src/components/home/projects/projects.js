...
export default function Projects() {
  const [list] = useState(projectsList);

  return (
    <SectionWrapper id="projects" className="mb-7" delay={0.3}>
          ...
          >
            <div className="w-auto">
              ...
              >
                <Image
                  src={`${project.img}`}
                  className="scale-100 md:w-[300px] lg:w-[350px] xl:w-[430px] md:h-[200px] lg:h-[220px] xl:h-[251px]"
                  width={430}
                  height={251}
                  loading="lazy"
